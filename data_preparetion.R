...
names(salary) <- c('Регион', 'январь-I квартал', 'февраль-I квартал', 'март-I квартал', 
                   'апрель-II квартал', 'май-II квартал', 'июнь-II квартал', 
                   'июль-III квартал', 'август-III квартал', 'сентябрь-III квартал', 
                   'октябрь-IV квартал', 'ноябрь-IV квартал', 'декабрь-IV квартал')
...
names(internet) <- c('Регион', 'I квартал', 'II квартал', 'III квартал', 'IV квартал')
...
internet$`I квартал` <- ifelse(internet$`I квартал` == '...', NA, internet$`I квартал`)
internet$`II квартал` <- ifelse(internet$`II квартал` == '...', NA, internet$`II квартал`)
internet$`III квартал` <- ifelse(internet$`III квартал` == '...', NA, internet$`III квартал`)
internet$`IV квартал` <- ifelse(internet$`IV квартал` == '...', NA, internet$`IV квартал`)

# заменяем значения с на те которые сверху

internet <- internet %>% fill(`I квартал`, .direction = 'down')
internet <- internet %>% fill(`II квартал`, .direction = 'down')
internet <- internet %>% fill(`III квартал`, .direction = 'down')
internet <- internet %>% fill(`IV квартал`, .direction = 'down')
...
internet$Квартал <- factor(internet$Квартал, levels = c('I квартал', 'II квартал', 'III квартал', 'IV квартал'))
str(internet)
